...
public abstract class CreateModuleAbstract extends StoneZoneModule {
    ...
    public abstract Block newConnectedPillarBlock(StoneType stoneType);
    public abstract Block newLayeredBlock(StoneType stoneType);
    ...
    private static class CreateClientModule {
        private static void registerConnectedBlock(CreateModuleAbstract module) {
