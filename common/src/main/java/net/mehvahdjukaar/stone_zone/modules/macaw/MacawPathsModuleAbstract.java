...
public abstract class MacawPathsModuleAbstract extends StoneZoneModule {
    ...
    public MacawPathsModuleAbstract(String modId) {
        ...
        running_bond_slabs = StoneZoneEntrySet.of(StoneType.class, "running_bond_slab",
                        ...
                        stoneType -> new SlabBlock(copyStandardProperties(stoneType))
                )
                .requiresChildren(BRICKS) //REASON: recipes
                //TEXTURES: running_bonds
                .addTag(BlockTags.MINEABLE_WITH_PICKAXE, Registries.BLOCK)
        ...
        running_bonds = StoneZoneEntrySet.of(StoneType.class, "running_bond",
                        ...
                        stoneType -> newEngravedBlock(copyStandardProperties(stoneType)
                        )
                )
                .requiresChildren(BRICKS) //REASON: recipes
        ...
        mossy_windmill_weave_paths = StoneZoneEntrySet.of(StoneType.class, "windmill_weave_path", "mossy",
                        ...
                        stoneType -> newPathBlock(getMossyCobblestoneSafe(stoneType))
                )
                .requiresChildren(MOSSY_BRICKS) //REASON: recipes
        ...
        mossy_windmill_weave_slabs = StoneZoneEntrySet.of(StoneType.class, "windmill_weave_slab", "mossy",
                        ...
                        stoneType -> new SlabBlock(getMossyCobblestoneSafe(stoneType))
                )
                .requiresChildren(MOSSY_BRICKS) //REASON: recipes
                //TEXTURES: mossy_windmill_weaves
                .addTag(BlockTags.MINEABLE_WITH_PICKAXE, Registries.BLOCK)
        ...
        mossy_windmill_weaves = StoneZoneEntrySet.of(StoneType.class, "windmill_weave", "mossy",
                        ...
                        stoneType -> newEngravedBlock(getMossyCobblestoneSafe(stoneType)
    ...
    public BlockBehaviour.Properties getMossyCobblestoneSafe(StoneType stoneType) {
        Block block = stoneType.getBlockOfThis(MOSSY_COBBLESTONE);
        Block baseBlock = (Objects.nonNull(block)) ? block : stoneType.stone;
        return Utils.copyPropertySafe(baseBlock)
                .requiresCorrectToolForDrops()
                .strength(1.5F, 4.0F);
    }
